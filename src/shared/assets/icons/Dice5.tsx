// @/shared/assets/icons/Dice5.tsx

export const DiceFive = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
        width="64"
        height="64"
        viewBox="0 0 64 64"
    ...
    >
        ...
        <circle cx="20" cy="20" r="5.5" fill="currentColor" stroke="currentColor" />
        ...
        <circle cx="44" cy="44" r="5.5" fill="currentColor" stroke="currentColor" />
    </svg>
);
